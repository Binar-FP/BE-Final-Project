...
const register = async (req, res) => {
  try {
    ...
    const data = {
      ...
      text: "hello word",
      html: '<p>You requested for email verification, kindly use this <a href="https://flywithmee.my.id/login?token='+token+'">link</a> to verify your email address</p>', // eslint-disable-line
    }
    sendMail(data)
