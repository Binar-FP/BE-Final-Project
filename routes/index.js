...
router.post("/api/create/airports", airports.addAirPort);
router.get("/api/airports", airports.findAirPorts);
router.get("/api/airports/:id", airports.findAirPortsById);
router.delete("/api/aiports/:id", airports.deleteAirPort);
router.put("/api/airports/:id", airports.updateAirPortById);
